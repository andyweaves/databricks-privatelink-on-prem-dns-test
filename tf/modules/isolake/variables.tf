...
variable "frontend_availability_zones" {
  description = "Availability zones for VM"
  type        = list(string)
}

variable "frontend_public_subnets_cidr" {
  description = "CIDR for VM public subnets"
  type        = list(string)
}

variable "frontend_private_subnets_cidr" {
  description = "CIDR for VM private subnets"
  type        = list(string)
}

variable "frontend_vpc_cidr_range" {
  description = "CIDR range for VM VPC"
  type        = string
}
...
variable "rdp_public_ip" {
  description = "Public IP for RDP access to VM"
  type        = string
}
...
variable "transit_vpc_cidr_range" {
  ...
  description = "CIDR range for transit VPC"
  type        = string
}

variable "transit_vpc_private_subnets_cidr" {

  description = "CIDR for transit private subnets"
  type        = list(string)
}

variable "transit_vpc_availability_zones" {

  description = "Availability zones for transit VPC"
  type        = list(string)
}